...
public class HTMLCovidDataTableBuilder extends AbstractCovidDataTableBuilder {
    ...
    @Autowired
    public HTMLCovidDataTableBuilder(CovidDataSource covidDataSource) {
    ...
    public String buildRegionsInfluencePercentOnGlobalStatRow(StatType statType) {
        ...
        Map<GeographicZone, int[]> regionalStats = sevenDayCovidData.get(tableDate).getRegionalCasesMap();
        List<GeographicZone> geographicZones = regionalStats.keySet()
                .stream()
